 ...
 * Termux .shortcuts/md-clip-plain script (same regex passes, same
 * order, moved here as part of migrating those shortcuts off Termux
 * entirely - asked for explicitly 2026-09-12). Operates on a plain
 * string instead of termux-clipboard-get/set; the caller (AssistActivity)
 * owns reading/writing the actual clipboard.
 */
